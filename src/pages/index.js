...
const IndexPage = () => (
  <Layout>
    <div className="description">
      ...
      <p>I also like to document my experiences, thoughts, and learning processes. You can click "Blog" to get to it or click <Link className="linkIndex" to="/blog">here</Link> for faster access.</p>
      <p>Would you like to collaborate? Perhaps leave some feedback? Talk about random things? You can reach out to me by going to the "Contact Me" section or click, you guessed it, <Link className="linkIndex" to="/contact">here</Link>.</p>
    </div>
  </Layout>
)
